...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const options = [
      `Awatif, your grace is the breath of my soul, In the light of your love, I am finally whole. I offer my life and a promise so true, Will you walk through forever with Eyad and "I do"?`,
      `Awatif, your love is the light in my soul, In your gentle heart, Eyad is made whole. With a promise of forever and a love deep and true, Will you marry me, darling, and let me love you?`,
      `Awatif, you are the music of my soul, The gentle grace that makes my spirit whole. In your love, Eyad has found his home— Will you walk with me, and never walk alone?`,
    ];

    if (ProposalStep.SUCCESS) {
      setAiPoem(options[Math.floor(Math.random() * options.length)]);
    }
  }, [ProposalStep]);
  ...
  const renderContent = () => {
    switch (step) {
      case ProposalStep.GREETING:
        return (
          <div className="text-center space-y-8 animate-fadeIn">
            <h1 className="text-4xl md:text-5xl font-romantic text-rose-600">
              Salam pretty girl...
            </h1>
      ...
      case ProposalStep.INTEREST:
        return (
          <div className="text-center space-y-8 animate-fadeIn">
            <h2 className="text-3xl md:text-4xl font-romantic text-rose-600">
              My name is Eyad ... <br /> nice to meet you cutie
            </h2>
            <div className="flex justify-center animate-popIn">
              <img src="/EyadAwatif/blueyedo.png" className="w-[30vh]" />
            </div>
            <p className="text-2xl text-rose-500 font-script italic">
              And ... I am very interested in you pretty girl...
            </p>
            <button
              onClick={nextStep}
              className="px-10 py-3 bg-rose-500 text-white rounded-full shadow-lg hover:bg-rose-600 transition-all transform hover:scale-110 active:scale-95 font-semibold"
      ...
      case ProposalStep.SUCCESS:
        return (
          <div className="text-center space-y-8 animate-popIn">
            ...
            <h1 className="text-5xl font-romantic text-rose-600">
              She said YES!
            </h1>
            <div className="flex justify-center animate-popIn">
              <img src="/EyadAwatif/EyadAwatif.png" className="w-[30vh]" />
            </div>
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-gradient-to-br from-rose-50 via-pink-100 to-rose-50 relative overflow-hidden">
      ...
      <div
        ref={cardRef}
        className={` relative z-10 w-full max-w-2xl bg-white/80 backdrop-blur-md rounded-[2.5rem] my-[30px] shadow-2xl p-5 md:p-16 border border-white/50 transition-all duration-700 ${isCelebration ? "bg-white/90 ring-8 ring-rose-200" : ""}`}
      >
